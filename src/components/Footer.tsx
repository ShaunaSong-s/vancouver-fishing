          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3">
                ...
                <a href="tel:6729657666" className="text-white/50 hover:text-gold-400 text-sm transition-colors">672-965-7666</a>
              </li>
              <li className="flex items-center gap-3">
                <svg className="w-4 h-4 text-gold-400/50 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
              ...
              <li className="flex items-center gap-3">
                <svg className="w-4 h-4 text-gold-400/50 shrink-0" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M8.691 2.188C3.891 2.188 0 5.476 0 9.53c0 2.212 1.17 4.203 3.002 5.55a.59.59 0 01.213.665l-.39 1.48c-.019.07-.048.141-.048.213 0 .163.13.295.29.295a.326.326 0 00.167-.054l1.903-1.114a.864.864 0 01.717-.098 10.16 10.16 0 002.837.403c.276 0 .543-.027.811-.05-.857-2.578.157-4.972 1.932-6.446 1.703-1.415 3.882-1.98 5.853-1.838-.576-3.583-4.196-6.348-8.596-6.348z" />
                </svg>
                <span className="text-white/50 text-sm">haishanghaidiao</span>
              </li>
            </ul>
          </div>
